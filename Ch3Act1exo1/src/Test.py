...
class Test(unittest.TestCase):
    ...
    def test_print(self):
        ...
        ans2 = _("Ta fonction n\'affiche rien. N'oublie pas que pour afficher quelque chose il faut faire appel à la fonction \'print()\'. Si tu as perdu les 2 print() donnés au début de l'exercice, tu peux rafraichir la page pour revoir l'énoncé de départ.")
        biais = 0
