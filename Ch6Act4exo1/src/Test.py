...
class Test(unittest.TestCase):
    def test_exists(self):
        self.assertTrue(hasattr(student, 'minuscule'), _("Tu n\'as pas defini la bonne fonction. La fonction 'minuscule' est introuvable."))
    ...
    def test_CasSpecial(self):
        a = [random.randint(33, 127) for _ in range(35)]
